...
.controller('HomeCtrl', function($scope) {
        ...
        $scope.light = function() {
            $scope.$root.bar = "bar-light";
            $scope.$root.tab = "tabs-light";
        };
        $scope.stable = function() {
            $scope.$root.bar = "bar-stable";
            $scope.$root.tab = "tabs-stable";
        };
        $scope.positive = function() {
            $scope.$root.bar = "bar-positive";
            $scope.$root.tab = "tabs-positive";
        };
        $scope.calm = function() {
            $scope.$root.bar = "bar-calm";
            $scope.$root.tab = "tabs-calm";
        };
        $scope.balanced = function() {
            $scope.$root.bar = "bar-balanced";
            $scope.$root.tab = "tabs-balanced";
        };
        $scope.energized = function() {
            $scope.$root.bar = "bar-energized";
            $scope.$root.tab = "tabs-energized";
        };
        $scope.assertive = function() {
            $scope.$root.bar = "bar-assertive";
            $scope.$root.tab = "tabs-assertive";
        };
        $scope.royal = function() {
            $scope.$root.bar = "bar-royal";
            $scope.$root.tab = "tabs-royal";
        };
        $scope.dark = function() {
            $scope.$root.bar = "bar-dark";
            $scope.$root.tab = "tabs-dark";
        };
})
...
.controller('EvidenceCtrl', function($scope, Evidences) {
        ...
        $scope.search = function($url) {
             ...
             aClient.get(url, function (answer) {
